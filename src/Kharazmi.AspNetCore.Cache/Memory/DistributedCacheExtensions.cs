...
namespace Kharazmi.AspNetCore.Cache.Memory
{
    ...
    public static class DistributedCacheExtensions
    {
        ...
        public static async Task<bool?> ReadBooleanAsync(this IDistributedCache cache, string key)
        {
            if (cache == null)
            {
        ...
        /// <exception cref="ArgumentNullException"><paramref name="cache"/> or <paramref name="key"/> is <c>null</c>.</exception>
        public static async Task<char?> ReadCharAsync(this IDistributedCache cache, string key)
        {
            if (cache == null)
            {
                throw new ArgumentNullException(nameof(cache));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="cache"/> or <paramref name="key"/> is <c>null</c>.</exception>
        public static async Task<decimal?> ReadDecimalAsync(this IDistributedCache cache, string key)
        {
            if (cache == null)
            {
                throw new ArgumentNullException(nameof(cache));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="cache"/> or <paramref name="key"/> is <c>null</c>.</exception>
        public static async Task<double?> ReadDoubleAsync(this IDistributedCache cache, string key)
        {
            if (cache == null)
            {
                throw new ArgumentNullException(nameof(cache));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="cache"/> or <paramref name="key"/> is <c>null</c>.</exception>
        public static async Task<short?> ReadShortAsync(this IDistributedCache cache, string key)
        {
            if (cache == null)
            {
                throw new ArgumentNullException(nameof(cache));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="cache"/> or <paramref name="key"/> is <c>null</c>.</exception>
        public static async Task<int?> ReadIntAsync(this IDistributedCache cache, string key)
        {
            if (cache == null)
            {
                throw new ArgumentNullException(nameof(cache));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="cache"/> or <paramref name="key"/> is <c>null</c>.</exception>
        public static async Task<long?> ReadLongAsync(this IDistributedCache cache, string key)
        {
            if (cache == null)
            {
                throw new ArgumentNullException(nameof(cache));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="cache"/> or <paramref name="key"/> is <c>null</c>.</exception>
        public static async Task<float?> ReadFloatAsync(this IDistributedCache cache, string key)
        {
            if (cache == null)
            {
                throw new ArgumentNullException(nameof(cache));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="cache"/> or <paramref name="key"/> is <c>null</c>.</exception>
        public static async Task<T> ReadJsonAsync<T>(this IDistributedCache cache, string key, Encoding encoding = null)
            where T : class
        {
            if (cache == null)
            {
        ...
        public static Task SetJsonAsync<T>(
            ...
            DistributedCacheEntryOptions options = null)
            where T : class =>
            SetJsonAsync<T>(cache, key, value, null, options);
