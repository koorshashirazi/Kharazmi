...
namespace Kharazmi.AspNetCore.Cache.EFCacheConfiguration
{
    ...
    public class EFCachedQueryable<TType> : IOrderedQueryable<TType>, IAsyncEnumerable<TType>
    {
            ...
            IEFCacheServiceProvider cacheServiceProvider)
        {
            ...
            _provider = new EfCachedQueryProvider(Query, cachePolicy, debugInfo, cacheKeyProvider,
        ...
        /// </summary>
        public IAsyncEnumerable<TType> AsyncEnumerable =>
            new EFAsyncEnumerable<TType>(this.AsEnumerable().GetEnumerator());
