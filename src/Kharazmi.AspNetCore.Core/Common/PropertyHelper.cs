...
{
    /// <summary>
    /// Get the string name and type of a property or field. Eg <c>string name = Property.AggregateType&lt;string&gt;(x =&gt; x.Length);</c>
    /// </summary>
    public static class PropertyHelper
    {
        /// <summary>
        /// Gets the type for the specified entity property or field. Eg <c>string name = Property.AggregateType&lt;string&gt;(x =&gt; x.Length);</c>
        /// </summary>
        ...
        /// <summary>
        /// Converts a nested property (eg. Studies.ID or Studies.Class.AggregateType) to string
        /// </summary>
