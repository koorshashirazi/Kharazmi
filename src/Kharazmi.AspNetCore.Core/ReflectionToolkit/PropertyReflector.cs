...
namespace Kharazmi.AspNetCore.Core.ReflectionToolkit
{
    ...
    ///     you could use "Parent.Parent.Parent.AggregateType".
    /// </summary>
    public class PropertyReflector
    {
        ...
        /// <param name="propertyName">the property to get, can be a property on a nested object (eg. "Child.AggregateType")</param>
        ...
        /// <param name="propertyName">the property to set, can be a property on a nested object (eg. "Child.AggregateType")</param>
