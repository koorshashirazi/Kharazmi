...
namespace Kharazmi.AspNetCore.Web.Mvc.HtmlHelpers
{
    public static class HtmlPrefixScopeExtensions
    {
            ...
            TCollectionItem model)
        {
            ...
            await htmlHelper.RenderPartialAsync(partialViewName, model, viewData).ConfigureAwait(false);
        }
            ...
            where TProperty : IEnumerable
        {
            ...
            foreach (var item in items)
            {
                ...
                {
                    await htmlHelper.RenderPartialAsync(partialViewName, item).ConfigureAwait(false);
                }
            }
        }
