...
namespace Kharazmi.AspNetCore.Web.TagHelpers
{
    ...
    public class AlphaPagerTagHelper : TagHelper
    {
        ...
        [HtmlAttributeName("cs-alphabet")] public string Alphabet { get; set; } = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
        ...
        [HtmlAttributeName("cs-all-label")] public string AllLabel { get; set; } = "All";

        [HtmlAttributeName("cs-all-value")] public string AllValue { get; set; } = string.Empty;
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            if (string.IsNullOrEmpty(AllLabel)) AllLabel = "All";
            alphabetList.Insert(0, AllLabel);
            if (IncludeNumbers) alphabetList.Insert(1, "0-9");
        ...
        private TagBuilder GenerateLinkTemplate()
        {
            ...
            if (Route == null)
                ...
                // Route and Action or ControllerType were specified. Can't determine the href attribute.
